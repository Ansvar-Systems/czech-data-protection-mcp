      ...
      switch (name) {
        ...
        case "cz_dp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "UOOU (Hellenic Data Protection Authority) MCP server. Provides access to Czech data protection authority decisions, sanctions, reprimands, and official guidance documents.",
            data_source: "UOOU (https://www.uoou.cz/)",
