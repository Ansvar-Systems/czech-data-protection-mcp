/**
 * SQLite database access layer for the UOOU MCP server.
 *
 * Schema:
 *   - decisions    — UOOU decisions, sanctions, and reprimands
 *   - guidelines   — UOOU guidance documents, opinions, and recommendations
