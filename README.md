...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fczech-data-protection-mcp.svg)](https://www.npmjs.com/package/@ansvar/czech-data-protection-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/czech-data-protection/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add czech-data-protection-mcp --transport http https://mcp.ansvar.eu/czech-data-protection/mcp` |
...
```json
{
  "mcpServers": {
    "czech-data-protection-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/czech-data-protection/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/czech-data-protection-mcp
```
...
```json
{
  "mcpServers": {
    "czech-data-protection-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/czech-data-protection-mcp"]
    }
  }
}
```
